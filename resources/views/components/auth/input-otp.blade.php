    ...
    <div class="flex items-center">
        @for ($x = 1; $x <= $digits; $x++)
            <input
                ...
                @class([
                    'flex size-10 items-center justify-center border border-zinc-300 bg-accent-foreground text-center text-sm font-medium text-accent-content transition-colors focus:relative focus:z-10 focus:border-2 focus:border-accent focus:outline-none dark:border-zinc-700 dark:focus:border-accent',
                    'rounded-l-md' => $x === 1,
